...
public class GetTimezonesResponse extends ConfigurationResponseBase<ConfigurationTimezone> {
    /**
     * Creates a new {@code GetTimezonesResponse}.
     *
     * @param results the list of timezones
     */
    public GetTimezonesResponse(final List<ConfigurationTimezone> results) {
        super(results);
    }
}
