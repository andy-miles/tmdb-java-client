...
@Builder
@Data
public class AddFavoriteRequest implements BodyBasedRequest, AccountBasedRequest, SessionBasedRequest {
    ...
    /** The media type (i.e., "movie" or "tv", required) */
    @BodyParameter
    ...
    /**
     * When {@code true}, the media is added as a favorite; else {@code false}, removes the media as a favorite
     * (required).
     */
