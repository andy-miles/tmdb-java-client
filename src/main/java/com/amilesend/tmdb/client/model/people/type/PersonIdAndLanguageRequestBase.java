...
/**
 * Defines the base class for a request that requires the person identifier and allows for an optional
 * language specifier.
 *
...
public class PersonIdAndLanguageRequestBase extends PersonIdRequestBase {
