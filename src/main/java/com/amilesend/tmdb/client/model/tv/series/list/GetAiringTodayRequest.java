 ...
 */
package com.amilesend.tmdb.client.model.tv.series.list;

import com.amilesend.tmdb.client.model.QueryParameter;
import com.amilesend.tmdb.client.model.tv.series.list.type.PaginatedSeriesListBasedRequest;
 ...
 *
 * @see PaginatedSeriesListBasedRequest
 */
@SuperBuilder
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class GetAiringTodayRequest extends PaginatedSeriesListBasedRequest {
