 ...
 *
 * @see ConfigurationCountry
 * @see ConfigurationResponseBase
 */
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class GetCountriesResponse extends ConfigurationResponseBase<ConfigurationCountry> {
    /**
     * Creates a new {@code GetCountriesResponse}.
     *
     * @param results the list of countries
     */
    public GetCountriesResponse(final List<ConfigurationCountry> results) {
        super(results);
    }
}
