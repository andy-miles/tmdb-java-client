 ...
 *
 * @see Resource
 * @see ScreenedTvSeriesEpisode
 */
@SuperBuilder
@Getter
@ToString(callSuper = true)
public class GetScreenedTheatricallyResponse extends Resource<Integer, GetScreenedTheatricallyResponse> {
    /** The list of TV series episodes that were screened theatrically. */
    private final List<ScreenedTvSeriesEpisode> results;
}
