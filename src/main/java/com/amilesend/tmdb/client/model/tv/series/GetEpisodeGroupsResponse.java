...
public class GetEpisodeGroupsResponse extends Resource<Integer, GetEpisodeGroupsResponse> {
    /** The list of episode groups for a series. */
    private final List<EpisodeGroup> results;
}
