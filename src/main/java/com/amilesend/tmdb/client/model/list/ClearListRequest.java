...
public class ClearListRequest extends ListRequestBase implements BodyBasedRequest {
    /** The confirmation flag indicator to clear the list (required). */
    @GsonExclude
    @QueryParameter
    ...
    public HttpUrl.Builder populateQueryParameters(@NonNull final HttpUrl.Builder urlBuilder) {
        return super.populateQueryParameters(urlBuilder)
                .addQueryParameter("confirm", String.valueOf(confirm));
    }
}
