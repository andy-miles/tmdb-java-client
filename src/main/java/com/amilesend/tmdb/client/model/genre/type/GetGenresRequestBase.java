...
@SuperBuilder
@Data
public abstract class GetGenresRequestBase implements QueryParameterBasedRequest {
    /** The ISO 639-1 language. */
    @QueryParameter
    private final String language;

    @Override
    public HttpUrl.Builder populateQueryParameters(HttpUrl.Builder urlBuilder) {
