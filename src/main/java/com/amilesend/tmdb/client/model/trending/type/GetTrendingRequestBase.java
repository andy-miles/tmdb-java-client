...
@SuperBuilder
@Data
public abstract class GetTrendingRequestBase implements QueryParameterBasedRequest {
    /** The time window used to constrain the expected list (required). */
    @PathParameter
    ...
    public HttpUrl.Builder populateQueryParameters(@NonNull final HttpUrl.Builder urlBuilder) {
        Validate.notNull(timeWindow, "timeWindow must not be null");
