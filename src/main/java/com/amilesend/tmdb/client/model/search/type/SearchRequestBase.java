...
public class SearchRequestBase implements QueryParameterBasedRequest {
    ...
    /** The page to retrieve for a paginated list (optional). */
    @QueryParameter
    ...
    public HttpUrl.Builder populateQueryParameters(@NonNull final HttpUrl.Builder urlBuilder) {
        ...
        urlBuilder.addQueryParameter("query", URLEncoder.encode(query, StandardCharsets.UTF_8));
        return appendIfNotNull(urlBuilder, "page", page);
    }
}
